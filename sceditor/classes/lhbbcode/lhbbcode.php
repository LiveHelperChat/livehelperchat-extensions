...
class erLhcoreClassBBCode
{
   ...
   public static function BBCode2Html($text) {
    	...
    	// Smileys to find..., sync with chat.tpl.php
    	$in = array( 	 'B)',
						 '#:-S',
						 'O:-)',
						 ':!!',
    	...
    	// And replace them by...
    	$out = array(	 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/26.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/18.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/25.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/110.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/111.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/112.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/113.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/cheer.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/studying.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/102.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/14.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/19.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/23.gif').'" />',
    					 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/2.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/3.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/4.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/5.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/7.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/8.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/32.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/10.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/11.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/12.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/13.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/15.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/16.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/17.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/1.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/20.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/21.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/37.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/22.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/41.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/45.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/43.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/103.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/24.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/100.gif').'" />',
						 '<img alt="" src="'.erLhcoreClassDesign::design('images/smileys/101.gif').'" />'
    	);
